...
filename_quast = '/mnt/bigdisk/Quality_performance_of_WGS_analysis_pipelines/Results/multi/multiqc_quast1.tsv'
...
kuk.to_csv(name[1]+'_results.tsv', sep='\t', encoding='utf-8') #save to csv with name of run
