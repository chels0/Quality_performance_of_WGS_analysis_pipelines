...
cat coli_cgMLST/cgMLSTschema.txt |sed -e "s|^|/home/chelsea/Documents/Quality_performance_of_WGS_analysis_pipelines/chewbbaca_test/Coli/coli_schema/|g" > coli_cgMLST/fullpath_cgMLSTschema.txt
