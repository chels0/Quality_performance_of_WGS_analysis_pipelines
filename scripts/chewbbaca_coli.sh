...
cat coli_cgMLST/cgMLSTschema.txt |sed -e "s|^|/home/chelsea/Documents/Quality_performance_of_WGS_analysis_pipelines/Results/chewbbaca/coli_schema/|g" > coli_cgMLST/fullpath_cgMLSTschema.txt

#Allele call cgMLST

chewBBACA.py AlleleCall -i /home/chelsea/Documents/Quality_performance_of_WGS_analysis_pipelines/Results/No_trimming/assemblies/ -g coli_cgMLST/fullpath_cgMLSTschema.txt -o results_cgMLST_coli --cpu 6
